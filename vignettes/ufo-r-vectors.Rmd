...
```
00 00 00 00  01 00 00 00  02 00 00 00  03 00 00 00  # 0 1 2 4
04 00 00 00  05 00 00 00  06 00 00 00  07 00 00 00  # 4 5 6 7
08 00 00 00  09 00 00 00                            # 8 9
```
...
```{r}
bin_vector[rev(seq.int(1, length(bin_vector), 100000))]
```
...
```
0F 00 00 00  01 00 00 00  02 00 00 00  03 00 00 00  
04 00 00 00  05 00 00 00  06 00 00 00  07 00 00 00  
08 00 00 00  09 00 00 00  0A 00 00 00  0B 00 00 00  
0C 00 00 00  0D 00 00 00  0E 00 00 00  0F 00 00 00  
...          ...          ...          ...
...
```{bash}
echo "select * from example limit 10" | psql -U $USER -d ufos
```
