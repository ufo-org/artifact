...
- R 3.6.0 or higher
- Linux 5.7 or higher (we currently do not support other operating systems)
...
TODO: need to install devtools too, which requires curl, xml2, openssl
libssl-dev libxml2-dev libcurl4-openssl-dev
also need rmarkdown to run tests
also pdflatex
```R
